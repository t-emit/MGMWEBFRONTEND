// src/pages/download/AuditedStatementsPage.jsx

import React from 'react';
import { FaDownload } from 'react-icons/fa';

// --- Data for the Audited Statements Page ---
const auditedStatements = [
    { title: "Balance sheet 2022-23", link: "/pdfs/Audited/Balance sheet 2022-23.pdf" },
    { title: "Balance sheet 2021-22", link: "/pdfs/Audited/Balance sheet 2021-22.pdf" },
    { title: "Balance sheet 2020-21", link: "/pdfs/Audited/Balance sheet 2020-21.pdf" },
    // You can add more statements to this array as needed.
];
                ...
                <div className="bg-white p-8 rounded-lg shadow-lg">
                    <div className="overflow-x-auto">
                        <table className="w-full border-collapse border border-gray-300">
                            ...
                            <tbody>
                                {auditedStatements.map((doc, index) => (

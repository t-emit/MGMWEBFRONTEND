...
import { civilDepartmentTabs } from './civilConstants'; // Import sub-navigation tabs
 ...
 * Refactored to match the template and navigation style of CivilAchievementPage.jsx.
 */
const CivilVisionMissionPage = () => {
    const location = useLocation();

    // Helper component for section titles with icons, mirroring achievement page style
    const SectionTitleWithIcon = ({ title, svgPath, iconColorClass, textColorClass = "text-indigo-800" }) => (
        <h3 className={`text-2xl font-bold ${textColorClass} mb-4 flex items-center print:text-xl justify-center`}>
            <svg className={`w-7 h-7 mr-2 ${iconColorClass} print:hidden`} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    return (
        <div className="container mx-auto px-4 py-8 mt-28 max-w-6xl print:mt-4 print:max-w-none">
            ...
            <div className="bg-gradient-to-r from-blue-900 to-indigo-900 rounded-xl p-8 md:p-12 text-white mb-6 shadow-2xl relative overflow-hidden print:bg-blue-900 print:shadow-none print:rounded-none print:p-6">
                <div className="absolute top-0 right-0 -mt-16 -mr-16 opacity-10 print:hidden">
                    ...
                    <svg className="w-64 h-64" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path d="M14 10h-4V3H8v7H4v2h4v8h2v-8h4v-2zm-6 0v2H4v-2h4zM20 12h-2v-2h-2v2h-2v2h2v2h2v-2h2v-2zM17 20h2v-2h-2v2zM17 4h2v2h-2V4zM7 20h2v-2H7v2zM7 4h2v2H7V4z"></path>
                    </svg>
                </div>
            ...
            <nav className={`mb-8 bg-white rounded-lg shadow-md transition-all duration-300 print:hidden`}>
                ...
                {/* Updated grid for better tab distribution */}
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 md:p-8 mb-10 border border-gray-100 print:shadow-none print:border-none print:rounded-none"> {/* Consistent border with achievement page */}
                <h2 className="text-3xl font-bold mb-6 text-indigo-800 border-b-2 border-indigo-100 pb-4 flex items-center print:text-2xl"> {/* Consistent heading style */}
                    <svg className="w-8 h-8 mr-3 text-indigo-500 print:hidden" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4"></path> {/* Kept original 'guiding statements' icon */}
                    </svg>

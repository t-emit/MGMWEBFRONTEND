...
const IntellectualPropertyCellPage = () => {
    ...
    return (
        <div className="container mx-auto px-4 py-8 mt-28 max-w-6xl print:mt-4 print:max-w-none">
            {/* Hero Section - Changed to Indigo/Blue Gradient */}
            <div className="bg-gradient-to-r from-blue-900 to-indigo-900 rounded-xl p-8 md:p-12 text-white mb-6 shadow-2xl relative overflow-hidden print:bg-blue-900 print:shadow-none">
                <div className="absolute top-0 right-0 -mt-16 -mr-16 opacity-10 print:hidden">
                    {/* Icon (Keeping original for context, but note it's the same as ResearchProfilePage) */}
                ...
                {/* Accent line - Changed to Blue/Indigo Gradient */}
                        ...
                        return (
                            <Link
                                ...
                                className={`p-3 text-center rounded-md transition-all duration-300 ease-in-out whitespace-nowrap text-sm font-medium
                                    ${isActive
                                    // Active tab - Changed to Indigo
                                    ? 'bg-indigo-100 text-indigo-700 border-2 border-indigo-300 shadow-inner'
                                    // Inactive tab hover - Changed to Indigo
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 md:p-8 mb-10 border border-gray-100 print:shadow-none print:border-none">
                ...
                <div className="overflow-x-auto relative rounded-xl shadow-md mb-12 border border-gray-200 print:shadow-none">
                    <table className="w-full text-sm text-left text-gray-700 print:text-xs">
                        {/* Table Header - Changed to Indigo Gradient */}
                        ...
                        <tbody>
                            {committeeMembers.map((member, index) => (
                                // Table Row Hover - Changed to Indigo-50
                ...
                {/* IP Cell Activities Section Title - Changed to Indigo and Border-b to Indigo-100 */}
                <h2 className="text-3xl font-bold mb-6 text-indigo-800 border-b-2 border-indigo-100 pb-4 flex items-center print:text-2xl">
                    IP Cell Activities
                </h2>

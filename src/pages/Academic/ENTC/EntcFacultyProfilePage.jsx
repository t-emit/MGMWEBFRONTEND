// src/pages/Academic/Entc/EntcFacultyProfilePage.jsx
import React from 'react';
import { Link, useLocation } from 'react-router-dom';
import { entcDepartmentTabs, entcTeachingStaff, entcSupportingStaff } from './entcConstants'; // Import entc faculty data

const EntcFacultyProfilePage = () => {
  const location = useLocation(); // Hook to get the current URL path

  const currentDeptPath = "/academics/electronincs-telecommunication-engineering"; // Base path for ENTC department
    ...
    <div className="container mx-auto px-4 py-8 mt-28 max-w-6xl print:mt-4 print:max-w-none">
      ...
      <div className="bg-gradient-to-r from-blue-900 to-indigo-900 rounded-xl p-8 md:p-12 text-white mb-6 shadow-2xl relative overflow-hidden print:bg-blue-900 print:shadow-none print:rounded-none print:p-6">
        ...
        <p className="text-xl opacity-90 max-w-2xl relative z-10 print:text-lg">
          Meet the dedicated and experienced faculty members of the Electronics & Telecommunication Engineering Department.
        </p>
      ...
      <div className="bg-white rounded-xl shadow-lg p-6 md:p-8 mb-10 border border-gray-100 print:shadow-none print:border-none print:rounded-none">
        <h2 className="text-3xl font-bold mb-8 text-indigo-800 border-b-2 border-indigo-200 pb-4 flex items-center print:text-2xl">
          ...
          Electronics & Telecommunication Engineering Faculty
        </h2>
            ...
            <div key={faculty.id} className="bg-gray-50 rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300 transform hover:-translate-y-1 print:shadow-none print:border print:rounded-none">
              <Link to={`${currentDeptPath}/faculty/${faculty.id}`} className="block">
                ...
                <div className="p-4 text-center print:p-2">
                  ...
                  <p className="text-xs text-gray-500 mt-1 print:text-xxs">{faculty.specialization !== '-' && faculty.specialization !== 'N/A' ? faculty.specialization : 'Not Specified'}</p>
                  {faculty.email && faculty.email !== 'N/A' && faculty.email !== '' && (
            ...
            <div key={staff.id} className="bg-gray-50 rounded-xl shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300 transform hover:-translate-y-1 print:shadow-none print:border print:rounded-none">
              <Link to={`${currentDeptPath}/faculty/${staff.id}`} className="block">
                ...
                <div className="p-4 text-center print:p-2">
                  ...
                  <p className="text-xs text-gray-500 mt-1 print:text-xxs">{staff.specialization !== '-' && staff.specialization !== 'N/A' ? staff.specialization : 'Not Specified'}</p>
                  {staff.email && staff.email !== 'N/A' && staff.email !== '' && (
...
export default EntcFacultyProfilePage;
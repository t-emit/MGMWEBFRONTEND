...
const EntcFacultyDetailPage = () => {
    const { facultyId } = useParams(); // Get facultyId from URL (e.g., 'kalpana-c-jondhale-paithane')
    ...
    return (
        <div className="container mx-auto px-4 py-8 mt-28 max-w-6xl print:mt-4 print:max-w-none">
            ...
            <div className="bg-gradient-to-r from-blue-900 to-indigo-900 rounded-xl p-8 md:p-12 text-white mb-12 shadow-2xl relative overflow-hidden print:bg-blue-900 print:shadow-none print:rounded-none print:p-6">
                ...
                <p className="text-xl opacity-90 max-w-2xl relative z-10 print:text-lg">Detailed information about our Electronics & Telecommunication Engineering faculty member.</p>
            ...
            <div className="bg-white rounded-xl shadow-lg p-6 md:p-8 mb-10 border border-gray-100 print:shadow-none print:border-none print:rounded-none">
                ...
                <div className="flex flex-col md:flex-row items-start md:space-x-8 print:flex-col print:space-x-0">
                    ...
                    <div className="md:w-2/3 text-gray-700 leading-relaxed print:w-full print:text-sm">
                        ...
                        <p className="text-lg mb-2 print:text-base"><strong>Specialization:</strong> <span className="font-medium">{facultyDetails.specialization !== '-' && facultyDetails.specialization !== 'N/A' ? facultyDetails.specialization : 'Not Specified'}</span></p>
                        <p className="text-lg mb-2 print:text-base">
                            <strong>Email:</strong> {facultyDetails.email && facultyDetails.email !== 'N/A' && facultyDetails.email !== '' ?
                        ...
                        <p className="mt-6 p-4 bg-gray-50 rounded-lg border border-gray-200 shadow-sm italic print:text-xs print:bg-white print:p-0 print:border-none print:shadow-none">
                            ...
                            You would typically fetch this additional content from an API or a data source if available.
                        </p>

// src/pages/Academic/Entc/EntcLaboratoryPage.jsx
import React from 'react';
import { Link, useLocation } from 'react-router-dom';
import { entcDepartmentTabs, entcLaboratories, allEntcFacultyData } from './entcConstants'; // Import E&TC lab and faculty data

const EntcLaboratoryPage = () => {
  ...
  const getFacultyForIncharge = (inchargeName) => {
    return allEntcFacultyData.find(f => f.name === inchargeName);
  };
    ...
    <div className="container mx-auto px-4 py-8 mt-28 max-w-6xl print:mt-4 print:max-w-none">
      ...
      <div className="bg-gradient-to-r from-blue-900 to-indigo-900 rounded-xl p-8 md:p-12 text-white mb-6 shadow-2xl relative overflow-hidden print:bg-blue-900 print:shadow-none print:rounded-none print:p-6">
        <div className="absolute top-0 right-0 -mt-16 -mr-16 opacity-10 print:hidden">
          {/* Custom SVG for Laboratory theme (e.g., circuit board or microchip) */}
        ...
        <p className="text-xl opacity-90 max-w-2xl relative z-10 print:text-lg">
          Explore the state-of-the-art laboratories and facilities of the Electronics & Telecommunication Engineering Department.
        </p>
      ...
      <div className="bg-white rounded-xl shadow-lg p-6 md:p-8 mb-10 border border-gray-100 print:shadow-none print:border-none print:rounded-none">
        <h2 className="text-3xl font-bold mb-6 text-indigo-800 border-b-2 border-indigo-100 pb-4 flex items-center print:text-2xl">
          ...
          Electronics & Telecommunication Engineering Laboratories
        </h2>
        ...
        <div className="overflow-x-auto relative rounded-xl shadow-md mb-8 border border-gray-200 print:shadow-none print:border print:rounded-none">
          <table className="w-full text-sm text-left text-gray-700 print:text-xs">
            ...
            <tbody>
              {entcLaboratories.map((lab, index) => {
        ...
        {/* General description about the labs */}
        <div className="prose prose-lg max-w-none text-gray-700 mt-10 print:text-sm">
          <p className="mb-4">
            The Electronics & Telecommunication Engineering Department is equipped with state-of-the-art laboratories
            that provide a comprehensive learning environment for students. These labs facilitate practical understanding
            of concepts across various domains of E&TC, from fundamental electronics to advanced communication systems and VLSI design.
          </p>
          <p>
            Our facilities are designed to foster innovation, hands-on skills, and research capabilities, preparing students
            for the dynamic challenges of the industry.
          </p>
        </div>
      </div>
    </div>
...
export default EntcLaboratoryPage;